...
class DataSource:
    ...
    def Get_Data(self, Data: Optional[Literal["calculated data", "original data"]] = None) -> Union[pd.DataFrame, None]:
        """
    ...
    def Fill_BlankCol(self, *,
                      ...
                      Value_Exception: Optional[Union[str, List[str]]] = None) -> None:
        """
    ...
    def Calc_HighestOffense(self, Group_By: Optional[str] = None, Find_Class: Optional[str] = None):
        """
